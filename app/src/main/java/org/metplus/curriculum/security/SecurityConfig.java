...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private String[] actuatorEndpoints() {
        return new String[]{BaseController.AUTOCONFIG_ENDPOINT, BaseController.BEANS_ENDPOINT, BaseController.CONFIGPROPS_ENDPOINT,
                BaseController.ENV_ENDPOINT, BaseController.MAPPINGS_ENDPOINT,
                BaseController.METRICS_ENDPOINT, BaseController.SHUTDOWN_ENDPOINT};
    }
