...
import org.metplus.curriculum.api.RequestHandlerMapping;
...
/**
     ...
     * @since 3.2
     */
    public class MyStandaloneBuilder extends AbstractMockMvcBuilder<MyStandaloneBuilder> {
         ...
         */
        public MyStandaloneBuilder(Object... controllers) {
         ...
         * @since 4.2
         */
        public MyStandaloneBuilder setControllerAdvice(Object... controllerAdvice) {
         ...
         */
        public MyStandaloneBuilder setMessageConverters(HttpMessageConverter<?>...messageConverters) {
         ...
         */
        public MyStandaloneBuilder setValidator(Validator validator) {
         ...
         */
        public MyStandaloneBuilder setConversionService(FormattingConversionService conversionService) {
         ...
         */
        public MyStandaloneBuilder addInterceptors(HandlerInterceptor... interceptors) {
         ...
         */
        public MyStandaloneBuilder addMappedInterceptors(String[] pathPatterns, HandlerInterceptor... interceptors) {
         ...
         */
        protected MyStandaloneBuilder setContentNegotiationManager(ContentNegotiationManager contentNegotiationManager) {
         ...
         */
        public MyStandaloneBuilder setAsyncRequestTimeout(long timeout) {
         ...
         */
        public MyStandaloneBuilder setCustomArgumentResolvers(HandlerMethodArgumentResolver... argumentResolvers) {
         ...
         */
        public MyStandaloneBuilder setCustomReturnValueHandlers(HandlerMethodReturnValueHandler... handlers) {
         ...
         */
        public MyStandaloneBuilder setHandlerExceptionResolvers(List<HandlerExceptionResolver> exceptionResolvers) {
         ...
         */
        public MyStandaloneBuilder setHandlerExceptionResolvers(HandlerExceptionResolver... exceptionResolvers) {
         ...
         */
        public MyStandaloneBuilder setViewResolvers(ViewResolver...resolvers) {
         ...
         */
        public MyStandaloneBuilder setSingleView(View view) {
         ...
         */
        public MyStandaloneBuilder setLocaleResolver(LocaleResolver localeResolver) {
         ...
         */
        public MyStandaloneBuilder setFlashMapManager(FlashMapManager flashMapManager) {
         ...
         */
        public MyStandaloneBuilder setUseSuffixPatternMatch(boolean useSuffixPatternMatch) {
         ...
         * <p>The default value is {@code true}.
         */
        public MyStandaloneBuilder setUseTrailingSlashPatternMatch(boolean useTrailingSlashPatternMatch) {
         ...
         */
        public MyStandaloneBuilder setRemoveSemicolonContent(boolean removeSemicolonContent) {
         ...
         * @since 4.2.8
         */
        public MyStandaloneBuilder addPlaceholderValue(String name, String value) {
        ...
        private void registerMvcSingletons(StubWebApplicationContext wac) {
            ...
            RequestHandlerMapping hm = config.getHandlerMapping();
        ...
        private class StandaloneConfiguration extends WebMvcConfigurationSupport {
            ...
            public RequestHandlerMapping getHandlerMapping() {
                RequestHandlerMapping handlerMapping = new RequestHandlerMapping(baseUrlApi);
