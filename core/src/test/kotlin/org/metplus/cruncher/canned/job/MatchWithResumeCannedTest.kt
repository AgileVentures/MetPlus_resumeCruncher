...
internal class MatchWithResumeCannedTest {
    ...
    fun beforeEach() {
        ...
        jobRepositoryFake.save(Job("1", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("2", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("3", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("4", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("5", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("6", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("7", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("8", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("9", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("10", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("11", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
        jobRepositoryFake.save(Job("15", title = "Some title", description = "some description", titleMetaData = CruncherMetaData(mutableMapOf()), descriptionMetaData = CruncherMetaData(mutableMapOf())))
    }
