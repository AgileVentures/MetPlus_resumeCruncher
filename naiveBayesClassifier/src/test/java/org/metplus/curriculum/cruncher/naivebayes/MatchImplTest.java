...
public class MatchImplTest implements BeforeAfterInterface {

    private JobRepository jobRespository = mock(JobRepository.class);
    private ResumeRepository resumeRespository = mock(ResumeRepository.class);

    @Rule
    public BeforeAfterRule rule = new BeforeAfterRule(this);
    private MatchImpl matcher;
    private CruncherImpl cruncher;
    private Resume resumeCategoryOneAndTwo;
    private Resume resumeCategoryOne;
    private Job jobTitleCat1DescCat2;
    private Job jobTitleCat3DescCat4;
    ...
    private void setJobMetaData(Job job,
    ...
    private Resume createResume(List<String> categories) {
